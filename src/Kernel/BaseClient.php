...
class BaseClient
{
    ...
    /**
     * @var \Wise\Kernel\Contracts\AccessTokenInterface
     */
     ...
     * @param \Wise\Kernel\Contracts\AccessTokenInterface|null $accessToken
     */
    ...
    /**
     * @param \Wise\Kernel\Contracts\AccessTokenInterface $accessToken
     *
     * @return $this
     */
    ...
    protected function retryMiddleware()
    {
        return Middleware::retry(function (
            ...
            if ($retries < $this->app->config->get('http.max_retries', 1) && $response && $body = $response->getBody()) {
                ...
                if (!empty($response['errno']) && in_array(abs($response['errno']), [44001, 44002, 44003, 44004], true)) {
     ...
     * @param array $options
     *
     * @return \Wise\Kernel\Http\Response
     *
     * @throws \Wise\Kernel\Exceptions\InvalidConfigException
     */
